...
<body>
  ...
  <?php
    ...
    $con = mysqli_connect($server, $username, $password,"food_order");
      // if($con){
      //   echo '<script> alert("pawan"); </script>';
      // } 
      // else{
              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    <img src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bG9nb3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  ...
                  <form method = "post" class="login-form">
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="button"
                        style="width: 150px; height: 50px;" name= "loginButton ">Log
                        in</button> <br>
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <a href="sign-up.html"><button type="button" class="btn btn-outline-danger">Create
                          new</button></a>
                    </div>
